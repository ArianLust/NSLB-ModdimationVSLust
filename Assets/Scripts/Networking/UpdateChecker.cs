...
public class UpdateChecker {
    ...
    private static readonly string API_URL = "https://api.github.com/repos/ArianLust/NSLB-ModdimationVSLust/releases/latest";
    ...
    public async static void IsUpToDate(Action<bool, string> callback) {
        ...
        request.UserAgent = "arianlust/NSLB-ModdimationVSLust";
